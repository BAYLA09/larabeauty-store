...
const steps = [
  {
    num: "١",
    title: "اختاري روتينك",
    text: "ثلاث علكات: نوم، طاقة، أو تركيز. اختاري الواحدة أو الروتين الكامل.",
  },
  {
    num: "٢",
    title: "أكّدي طلبك (بدون دفع)",
    text: `اسمك ورقم جوالك فقط (${market.phoneCountryCode}). الدفع عند الاستلام.`,
  },
  {
    num: "٣",
    title: "استلمي وادفعي",
    text: `نوصّل لباب بيتك داخل ${market.countryName} خلال 2–4 أيام. كاش أو بطاقة.`,
  },
];
